...
int main()
{
	...
	// Tell GLFW what version of OpenGL using
	// in this case, I'm using OpenGL 3.3
	glfwWindowHint(GLFW_CONTEXT_VERSION_MAJOR, 3);
	glfwWindowHint(GLFW_CONTEXT_VERSION_MINOR, 3);
	// Tell GLFW I'm using CORE profile
	// Meaning only have modern functions
	glfwWindowHint(GLFW_OPENGL_PROFILE, GLFW_OPENGL_CORE_PROFILE);




	// Create a GLFWwindow object of 800 by 800 pixels, name "MyOpenGL"
	GLFWwindow* window = glfwCreateWindow(800, 800, "MyOpenGL", NULL, NULL);
	// Error if fails to create
	if (window == NULL)
	{
	...
	// Introduce current window context
